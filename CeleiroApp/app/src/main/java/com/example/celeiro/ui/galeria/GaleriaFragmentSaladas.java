...
public class GaleriaFragmentSaladas extends Fragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        com.example.celeiro.ui.galeria.GaleriaViewModelSaladas galeriaViewModelSaladas = new ViewModelProvider(this).get(com.example.celeiro.ui.galeria.GaleriaViewModelSaladas.class);
        View root = inflater.inflate(R.layout.fragment_galeria_saladas, container, false);
