...
public class GaleriaFragmentFestas extends Fragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        com.example.celeiro.ui.galeria.GaleriaViewModelFestas galeriaViewModelFestas = new ViewModelProvider(this).get(com.example.celeiro.ui.galeria.GaleriaViewModelFestas.class);
        View root = inflater.inflate(R.layout.fragment_galeria_festas, container, false);
