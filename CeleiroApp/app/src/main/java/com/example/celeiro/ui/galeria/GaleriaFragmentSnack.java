...
public class GaleriaFragmentSnack extends Fragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        com.example.celeiro.ui.galeria.GaleriaViewModelSnack galeriaViewModelSnack = new ViewModelProvider(this).get(com.example.celeiro.ui.galeria.GaleriaViewModelSnack.class);
        View root = inflater.inflate(R.layout.fragment_galeria_snack, container, false);
