...
public class GaleriaFragmentCasa extends Fragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        com.example.celeiro.ui.galeria.GaleriaViewModelCasa galeriaViewModelCasa = new ViewModelProvider(this).get(com.example.celeiro.ui.galeria.GaleriaViewModelCasa.class);
        View root = inflater.inflate(R.layout.fragment_galeria_casa, container, false);
